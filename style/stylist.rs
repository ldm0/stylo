...
pub use crate::lightmount_invalidation::{
    ...
    lightmount_attribute_change_can_use_retained_invalidator,
    lightmount_child_list_dependency_fallback_context_for_query,
    lightmount_child_list_sibling_boundary_plan,
    ...
    lightmount_collect_relative_style_invalidation_query_result,
    lightmount_dependency_changes_anchor_with_snapshot,
    lightmount_dependency_empty_result_supported_by_retained_processor,
    lightmount_dependency_invalidation_action, lightmount_dependency_is_relative_selector,
    lightmount_dependency_supported_by_retained_processor, lightmount_fallback_roots_plan,
    lightmount_merge_retained_source_invalidation_fallback_kind,
    lightmount_merge_retained_source_invalidation_kind,
    lightmount_merge_source_dependency_request_requirement,
    lightmount_merge_source_style_invalidation_query_results,
    lightmount_normal_style_invalidation_dependency_plan,
    lightmount_relative_dependency_changes_anchor,
    lightmount_relative_dependency_invalidation_action,
    lightmount_relative_selector_invalidation_fallback_reason,
    lightmount_relative_style_invalidation_dependency_plan,
    ...
    lightmount_retained_processor_dependency_effect,
    lightmount_retained_queries_for_element_dependency_snapshot,
    lightmount_retained_source_invalidation_kind_can_use_fallback_payload,
    lightmount_retained_source_style_invalidation_from_parts,
    lightmount_runtime_fallback_roots_for_mutation_inputs,
    lightmount_runtime_or_source_scope_fallback_plan,
    lightmount_snapshot_relative_outer_dependency_supported,
    lightmount_source_dependency_invalidation_batch_plan,
    lightmount_source_fallback_reason_for_unretained_state_change,
    lightmount_source_scope_fallback_plan, lightmount_state_change_can_use_retained_invalidator,
    lightmount_stylesheet_source_scope_fallback_roots,
    lightmount_visit_relative_dependency_candidates, LightmountChildListSiblingBoundaryKind,
    LightmountChildListSiblingBoundaryPlan, LightmountDependencyContextRootFlagsSink,
    LightmountDependencyContextRootPlan, LightmountDependencyInvalidationAction,
    LightmountDependencyInvalidationActionSink, LightmountDependencyInvalidationContextRoots,
    LightmountDependencyInvalidationContextRootsPartsSink,
    LightmountDependencyInvalidationContextRootsSink,
    LightmountDependencyInvalidationFallbackContext, LightmountDependencyInvalidationSummary,
    LightmountDependencyQueryResult, LightmountElementDependencySnapshot,
    LightmountInvalidationResult, LightmountInvalidationResultBuilder,
    LightmountInvalidationSourceResultsSink, LightmountNormalStyleInvalidationDependencyPlan,
    LightmountNormalStyleInvalidationDependencyPlanSink,
    LightmountPlannedFallbackRootInvalidationTarget,
    LightmountPlannedFallbackRootInvalidationTargetPartsSink,
    LightmountPlannedSourceDependencyInvalidation,
    LightmountPlannedSourceDependencyInvalidationPartsSink,
    LightmountPlannedSourceDependencyInvalidationTarget,
    LightmountPlannedSourceDependencyInvalidationTargetPartsSink,
    LightmountRelativeDependencyInvalidationAction,
    LightmountRelativeDependencyInvalidationActionSink,
    LightmountRelativeStyleInvalidationDependencyPlan, LightmountRetainedProcessorDependencyEffect,
    LightmountRetainedSourceStyleInvalidation, LightmountRetainedSourceStyleInvalidationKind,
    LightmountRetainedSourceStyleInvalidationSink,
    LightmountRetainedStyleChildListInvalidationQueries,
    LightmountRetainedStyleChildListInvalidationQueriesSink,
    LightmountRetainedStyleChildListInvalidationQuery,
    LightmountRetainedStyleChildListInvalidationQueryBuilder,
    LightmountRetainedStyleChildListMutationContext, LightmountRetainedStyleInvalidationQuery,
    LightmountRetainedStyleSiblingTraversal, LightmountRuntimeFallbackRootInput,
    LightmountRuntimeFallbackRootResolver, LightmountScopeDependencyInvalidationAction,
    LightmountScopeDependencyInvalidationActionSink, LightmountSiblingInvalidationSummary,
    LightmountSnapshotRelativeDependencyRoots, LightmountSourceAffectedRootsCleanup,
    LightmountSourceAffectedRootsCleanupSink, LightmountSourceDependencyBoundaryRoots,
    LightmountSourceDependencyInvalidationBatchPlan,
    LightmountSourceDependencyInvalidationBatchPlanSink,
    LightmountSourceDependencyInvalidationBatchSource,
    LightmountSourceDependencyInvalidationContextRootsProvider,
    LightmountSourceDependencyInvalidationRequest, LightmountSourceDependencyRequestRequirement,
    LightmountSourceDependencySummary, LightmountSourceFallbackRootAvailability,
    LightmountSourceFallbackRootAvailabilitySummary,
    LightmountSourceFallbackRootAvailabilitySummarySink,
    LightmountSourceInvalidationFallbackReason, LightmountSourceStyleInvalidationQuery,
    LightmountSourceStyleInvalidationQueryResult,
    LightmountSourceStyleInvalidationQueryResultBuilder, LightmountSourceStyleInvalidationResult,
    LightmountSourceStyleInvalidationResultAccumulator,
    LightmountSourceStyleInvalidationResultParts, LightmountSourceStyleInvalidationResultPartsSink,
    LightmountSourceStyleInvalidationResultSink, LightmountSourceStyleInvalidationSourceResult,
    LightmountSourceStyleInvalidationSourceResultKind,
    LightmountSourceStyleInvalidationSourceResultKindSummary,
    LightmountSourceStyleInvalidationSourceResultKindSummarySink,
    LightmountSourceStyleInvalidationSourceResultParts,
    LightmountSourceStyleInvalidationSourceResultPartsSink,
    LightmountSourceStyleInvalidationSourceResultSink,
    LightmountSourceStyleInvalidationTargetResultCleanupFacts,
    LightmountSourceStyleInvalidationTargetResultCleanupFactsPartsSink,
    LightmountSourceStyleInvalidationTargetResultCleanupFactsSink,
    LightmountSourceStyleInvalidationTargetResultDiagnosticFacts,
    LightmountSourceStyleInvalidationTargetResultDiagnosticFactsPartsSink,
    LightmountSourceStyleInvalidationTargetResultDiagnosticFactsSink,
    LightmountSourceStyleInvalidationTargetResultRecord, LightmountStateInvalidationRoot,
    LightmountStyleInvalidationElementRoot, LightmountStyleInvalidationProcessor,
    LightmountStyleInvalidationQuery, LightmountStyleInvalidationSnapshot,
    LightmountStyleInvalidationSnapshotAttribute, LightmountStyleMutationAttributeChange,
    LightmountStyleMutationElementSnapshot, LightmountStylesheetSourceScopeFallbackInput,
    LightmountStylesheetSourceScopeFallbackRootsResolver,
};
...
impl CascadeData {
    ...
    /// invalidation.
    pub fn lightmount_dependency_invalidation_summary(
        &self,
