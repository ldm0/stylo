...
pub mod font {
    ...
    use super::*;
    #[cfg(feature = "gecko")]
    use crate::properties::longhands::{font_family, font_size, font_size_adjust};
    use crate::properties::longhands::{
        ...
        font_variant_east_asian, font_variant_emoji, font_variant_ligatures, font_variant_numeric,
