...
pub mod font {
    ...
    use crate::properties::longhands::{
        font_kerning, font_optical_sizing, font_stretch, font_style, font_variant_alternates,
        font_variant_caps, font_variant_east_asian, font_variant_emoji, font_variant_ligatures,
